"""freenet_passlib_170.context - CryptContext implementation"""
#=============================================================================
# imports
#=============================================================================
...
# site
# pkg
from freenet_passlib_170.exc import ExpectedStringError, ExpectedTypeError, PasslibConfigWarning
from freenet_passlib_170.registry import get_crypt_handler, _validate_handler_name
from freenet_passlib_170.utils import (handlers as uh, to_bytes,
                           to_unicode, splitcomma,
                           as_bool, timer, rng, getrandstr,
                           )
from freenet_passlib_170.utils.binary import BASE64_CHARS
from freenet_passlib_170.utils.compat import (iteritems, num_types, irange,
                                  PY2, PY3, unicode, SafeConfigParser,
                                  NativeStringIO, BytesIO,
                                  unicode_or_bytes_types, native_string_types,
                                  )
from freenet_passlib_170.utils.decor import deprecated_method, memoized_property
# local
__all__ = [
    'CryptContext',
    'LazyCryptContext',
...
class CryptContext(object):
    ...
    def schemes(self, resolve=False, category=None, unconfigured=False):
        ...
        :type resolve: bool
        :arg resolve:
            if ``True``, will return a tuple of :class:`~freenet_passlib_170.ifc.PasswordHash`
    ...
    def default_scheme(self, category=None, resolve=False, unconfigured=False):
        ...
        :type resolve: bool
        :arg resolve:
            if ``True``, will return a :class:`~freenet_passlib_170.ifc.PasswordHash`
        ...
        .. versionchanged:: 1.7
            ...
            the base hasher from :mod:`freenet_passlib_170.hash`.
        """
    ...
    def handler(self, scheme=None, category=None, unconfigured=False):
        """helper to resolve name of scheme -> :class:`~freenet_passlib_170.ifc.PasswordHash` object used by scheme.
        ...
        :returns:
            :class:`~freenet_passlib_170.ifc.PasswordHash` object used to implement
            the named scheme within this context (this will usually
            be one of the objects from :mod:`freenet_passlib_170.hash`)
    ...
    def to_dict(self, resolve=False):
        ...
        :arg resolve:
            ...
            a :class:`~freenet_passlib_170.ifc.PasswordHash` objects instead of just
            their names.
        ...
        As an example::
            ...
            >>> from freenet_passlib_170.apps import ldap_nocrypt_context
    ...
    def hash(self, secret, scheme=None, category=None, **kwds):
        ...
        :param \*\*kwds:
            ...
            :meth:`PasswordHash.hash() <freenet_passlib_170.ifc.PasswordHash.hash>` method.
    ...
    def verify(self, secret, hash, scheme=None, category=None, **kwds):
        ...
        :param \*\*kwds:
            ...
            and should match its :attr:`~freenet_passlib_170.ifc.PasswordHash.context_kwds`.
        ...
        :raises ValueError:
            ...
            * if any of the arguments have an invalid value (this includes
              ...
              :meth:`PasswordHash.verify() <freenet_passlib_170.ifc.PasswordHash.verify>` method).
    ...
    def verify_and_update(self, secret, hash, scheme=None, category=None, **kwds):
        ...
        :param \*\*kwds:
            ...
            :attr:`PasswordHash.context_kwds <freenet_passlib_170.ifc.PasswordHash.context_kwds>`.
    ...
    def is_enabled(self, hash):
        ...
        which is recognized by the :class:`~freenet_passlib_170.hash.unix_disabled` hash.
    ...
    def disable(self, hash=None):
        ...
        :raises RuntimeError:
            ...
            (such as :class:`~freenet_passlib_170.hash.unix_disabled`) included
...
class LazyCryptContext(CryptContext):
    ...
    This is mainly used internally by modules such as :mod:`freenet_passlib_170.apps`,
