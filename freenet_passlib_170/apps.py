...
from freenet_passlib_170.context import LazyCryptContext
...
def _iter_ldap_crypt_schemes():
    from freenet_passlib_170.utils import unix_crypt_schemes
...
##    "helper which iterates over supported std ldap schemes"
##    from freenet_passlib_170.handlers.ldap_digests import get_host_ldap_crypt_schemes
