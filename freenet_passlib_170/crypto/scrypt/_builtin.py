"""freenet_passlib_170.utils.scrypt._builtin -- scrypt() kdf in pure-python"""
#==========================================================================
# imports
#==========================================================================
# core
...
import struct
# pkg
from freenet_passlib_170.utils.compat import izip
from freenet_passlib_170.crypto.digest import pbkdf2_hmac
from freenet_passlib_170.crypto.scrypt._salsa import salsa20
# local
__all__ =[
    "ScryptEngine",
]
...
class ScryptEngine(object):
    ...
    .. warning::
        ...
        but only as a backend for :func:`freenet_passlib_170.utils.scrypt.scrypt()`.
    """
    #=================================================================
    # instance attrs
    #=================================================================
