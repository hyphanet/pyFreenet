"""freenet_passlib_170.utils.scrypt -- scrypt hash frontend and help utilities"""
#==========================================================================
# imports
#==========================================================================
...
from freenet_passlib_170.utils.compat import PYPY
# local
__all__ =[
    "validate",
    "scrypt",
...
def _set_backend(name, dryrun=False):
    ...
    :raises ~freenet_passlib_170.exc.MissingBackendError: if backend can't be found
