"""freenet_passlib_170.win32 - MS Windows support - DEPRECATED, WILL BE REMOVED IN 1.8
...
See also :mod:`freenet_passlib_170.hash.nthash`.
"""

from warnings import warn
warn("the 'freenet_passlib_170.win32' module is deprecated, and will be removed in "
     "passlib 1.8; please use the 'freenet_passlib_170.hash.nthash' and "
     "'freenet_passlib_170.hash.lmhash' classes instead.",
     DeprecationWarning)
...
from freenet_passlib_170.hash import nthash
# local
__all__ = [
    "nthash",
    "raw_lmhash",
