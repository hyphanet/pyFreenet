"""tests for freenet_passlib_170.win32 -- (c) Assurance Technologies 2003-2009"""
#=============================================================================
# imports
#=============================================================================
# core
...
class UtilTest(TestCase):
    """test util funcs in freenet_passlib_170.win32"""
    ...
    def setUp(self):
        ...
        warnings.filterwarnings("ignore",
                                "the 'freenet_passlib_170.win32' module is deprecated")

    def test_lmhash(self):
        from freenet_passlib_170.win32 import raw_lmhash
        for secret, hash in [
    ...
    def test_nthash(self):
        ...
        from freenet_passlib_170.win32 import raw_nthash
        for secret, hash in [
