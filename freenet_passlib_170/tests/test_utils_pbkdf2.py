"""
freenet_passlib_170.tests -- tests for passlib.utils.pbkdf2
...
# pkg
# module
from freenet_passlib_170.utils.compat import u, JYTHON
from freenet_passlib_170.tests.utils import TestCase, hb
...
class UtilsTest(TestCase):
    ...
    descriptionPrefix = "freenet_passlib_170.utils.pbkdf2"
    ...
    def setUp(self):
        ...
        warnings.filterwarnings("ignore", ".*freenet_passlib_170.utils.pbkdf2.*deprecated", DeprecationWarning)

    def test_norm_hash_name(self):
        """norm_hash_name()"""
        from itertools import chain
        from freenet_passlib_170.utils.pbkdf2 import norm_hash_name
        from freenet_passlib_170.crypto.digest import _known_hash_names
...
class Pbkdf1_Test(TestCase):
    """test kdf helpers"""
    descriptionPrefix = "freenet_passlib_170.utils.pbkdf2.pbkdf1()"
    ...
    def test_known(self):
        ...
        from freenet_passlib_170.utils.pbkdf2 import pbkdf1
...
class Pbkdf2_Test(TestCase):
    """test pbkdf2() support"""
    descriptionPrefix = "freenet_passlib_170.utils.pbkdf2.pbkdf2()"
    ...
    def test_known(self):
        """test reference vectors"""
        from freenet_passlib_170.utils.pbkdf2 import pbkdf2
