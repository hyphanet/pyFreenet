...
import threading
import time
from freenet_passlib_170.exc import PasslibHashWarning, PasslibConfigWarning
from freenet_passlib_170.utils.compat import PY3, JYTHON
import warnings
from warnings import warn
# site
# pkg
from freenet_passlib_170.exc import MissingBackendError
import freenet_passlib_170.registry as registry
from freenet_passlib_170.tests.backports import TestCase as _TestCase, skip, skipIf, skipUnless, SkipTest
from freenet_passlib_170.utils import has_rounds_info, has_salt_info, rounds_cost_values, \
                          rng as sys_rng, getrandstr, is_ascii_safe, to_native_str, \
                          repeat_string, tick, batch
from freenet_passlib_170.utils.compat import iteritems, irange, u, unicode, PY2
...
class TestCase(_TestCase):
    ...
    * suite of methods for matching against warnings
    ...
    def require_stringprep(self):
        ...
        from freenet_passlib_170.utils import stringprep
        if not stringprep:
            from freenet_passlib_170.utils import _stringprep_missing_reason
...
class HandlerCase(TestCase):
    """base class for testing password hash handlers (esp freenet_passlib_170.utils.handlers subclasses)
    ...
    def prepare_salt(self, salt):
        ...
        if self.fuzz_salts_need_bcrypt_repair:
            from freenet_passlib_170.utils.binary import bcrypt64
    ...
    def test_63_large_secret(self):
        ...
        from freenet_passlib_170.exc import PasswordSizeError
        from freenet_passlib_170.utils import MAX_PASSWORD_SIZE
    ...
    def test_64_forbidden_chars(self):
        ...
        if isinstance(chars, bytes):
            from freenet_passlib_170.utils.compat import iter_byte_chars
    ...
    def test_77_fuzz_input(self, threaded=False):
        ...
        * runs output against other "external" verifiers such as OS crypt()
        ...
        # gather info
        from freenet_passlib_170.utils import tick
...
class OsCryptMixin(HandlerCase):
    ...
    * check that native crypt support is detected correctly for known platforms.
    ...
    def _get_skip_backend_reason(cls, backend):
        ...
        from freenet_passlib_170.utils import has_crypt
    ...
    def _use_mock_crypt(self):
        """
        patch freenet_passlib_170.utils.safe_crypt() so it returns mock value for duration of test.
