"""freenet_passlib_170.tests -- tests for passlib.pwd"""
#=============================================================================
# imports
#=============================================================================
# core
...
class UtilsTest(TestCase):
    ...
    descriptionPrefix = "freenet_passlib_170.pwd"

    def test_self_info_rate(self):
        """_self_info_rate()"""
        from freenet_passlib_170.pwd import _self_info_rate
    ...
    #     """_total_self_info()"""
    #     from freenet_passlib_170.pwd import _total_self_info
    #
...
# import subject
from freenet_passlib_170.pwd import genphrase
simple_words = ["alpha", "beta", "gamma"]

class PhraseGeneratorTest(TestCase):
    """test generation routines"""
    descriptionPrefix = "freenet_passlib_170.pwd.genphrase()"
