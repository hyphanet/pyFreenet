"""freenet_passlib_170.tests -- unittests for passlib.crypto.des"""
#=============================================================================
# imports
#=============================================================================
...
class DesTest(TestCase):
    descriptionPrefix = "freenet_passlib_170.crypto.des"
    ...
    def test_01_expand(self):
        """expand_des_key()"""
        from freenet_passlib_170.crypto.des import expand_des_key, shrink_des_key, \
    ...
    def test_02_shrink(self):
        """shrink_des_key()"""
        from freenet_passlib_170.crypto.des import expand_des_key, shrink_des_key, INT_64_MASK
        rng = self.getRandom()
    ...
    def _random_parity(self, key):
        ...
        from freenet_passlib_170.crypto.des import _KDATA_MASK, _KPARITY_MASK, INT_64_MASK
        rng = self.getRandom()
        return (key & _KDATA_MASK) | (rng.randint(0,INT_64_MASK) & _KPARITY_MASK)

    def test_03_encrypt_bytes(self):
        """des_encrypt_block()"""
        from freenet_passlib_170.crypto.des import (des_encrypt_block, shrink_des_key,
                                              _pack64, _unpack64)
    ...
    def test_04_encrypt_ints(self):
        ...
        from freenet_passlib_170.crypto.des import des_encrypt_int_block
