"""tests for freenet_passlib_170.context"""
#=============================================================================
# imports
#=============================================================================
# core
...
from freenet_passlib_170.exc import PasslibConfigWarning, PasslibHashWarning
from freenet_passlib_170.utils import tick, to_unicode
from freenet_passlib_170.utils.compat import irange, u, unicode, str_to_uascii, PY2, PY26
import freenet_passlib_170.utils.handlers as uh
from freenet_passlib_170.tests.utils import (TestCase, set_file, TICK_RESOLUTION,
                                 quicksleep, time_call, handler_derived_from)
from freenet_passlib_170.registry import (register_crypt_handler_path,
...
##        self.assertEqual(getdep(cc), ["md5_crypt"])
    ...
    def test_35_to_string(self):
        ...
        from freenet_passlib_170.tests.test_utils_handlers import UnsaltedHash
    ...
    def test_48_context_kwds(self):
        ...
        from freenet_passlib_170.hash import des_crypt, md5_crypt, postgres_md5
    ...
    def test_disabled_hashes(self):
        ...
        # init ref info
        #
        from freenet_passlib_170.hash import md5_crypt, unix_disabled
...
class LazyCryptContextTest(TestCase):
    ...
    def test_kwd_constructor(self):
        ...
        register_crypt_handler_path("dummy_2", "freenet_passlib_170.tests.test_context")
