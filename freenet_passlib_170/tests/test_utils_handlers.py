...
# site
# pkg
from freenet_passlib_170.hash import ldap_md5, sha256_crypt
from freenet_passlib_170.exc import MissingBackendError, PasslibHashWarning
from freenet_passlib_170.utils.compat import str_to_uascii, \
                                 uascii_to_str, unicode
import freenet_passlib_170.utils.handlers as uh
from freenet_passlib_170.tests.utils import HandlerCase, TestCase
...
class dummy_handler_in_registry(object):
    ...
    def __enter__(self):
        from freenet_passlib_170 import registry
...
# parts of freenet_passlib_170. they shouldn't be used as actual password schemes.
#=============================================================================
