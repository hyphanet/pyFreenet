"""tests for freenet_passlib_170.hash -- (c) Assurance Technologies 2003-2009"""
#=============================================================================
# imports
#=============================================================================
...
# site
# pkg
from freenet_passlib_170 import hash, registry, exc
from freenet_passlib_170.registry import register_crypt_handler, register_crypt_handler_path, \
...
from freenet_passlib_170.tests.utils import TestCase
# module
...
class RegistryTest(TestCase):
    ...
    descriptionPrefix = "freenet_passlib_170.registry"
    ...
    def test_hash_proxy(self):
        """test freenet_passlib_170.hash proxy object"""
        # check dir works
        dir(hash)
    ...
    def test_register_crypt_handler_path(self):
        ...
        sys.modules.pop("freenet_passlib_170.tests._test_bad_register", None)
        register_crypt_handler_path("dummy_bad", "freenet_passlib_170.tests._test_bad_register")
        with warnings.catch_warnings():
            warnings.filterwarnings("ignore", "xxxxxxxxxx", DeprecationWarning)
            h = get_crypt_handler("dummy_bad")
        from freenet_passlib_170.tests import _test_bad_register as tbr
    ...
    def test_get_crypt_handler(self):
        ...
        import freenet_passlib_170.hash # ensure module imported, so py3.3 sets __package__
        freenet_passlib_170.hash.__dict__["_fake"] = "dummy" # so behavior seen under py2x also
    ...
    def test_list_crypt_handlers(self):
        ...
        from freenet_passlib_170.registry import list_crypt_handlers
