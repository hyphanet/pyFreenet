"""test freenet_passlib_170.ext.django"""
#=============================================================================
# imports
#=============================================================================
# core
...
# site
# pkg
from freenet_passlib_170 import apps as _apps, exc, registry
from freenet_passlib_170.apps import django10_context, django14_context, django16_context
from freenet_passlib_170.context import CryptContext
from freenet_passlib_170.ext.django.utils import (
    DJANGO_VERSION, MIN_DJANGO_VERSION, DjangoTranslator,
)
from freenet_passlib_170.utils.compat import iteritems, get_method_function, u
from freenet_passlib_170.utils.decor import memoized_property
# tests
from freenet_passlib_170.tests.utils import TestCase, TEST_MODE, handler_derived_from
from freenet_passlib_170.tests.test_handlers import get_handler_case, conditionally_available_hashes
# local
__all__ = [
    "DjangoBehaviorTest",
...
# XXX: move these to freenet_passlib_170.apps?
...
from freenet_passlib_170.hash import django_pbkdf2_sha256
sample_hashes = dict(
...
class _ExtensionSupport(object):
    ...
    def assert_unpatched(self):
        ...
        mod = sys.modules.get("freenet_passlib_170.ext.django.models")
        ...
        for obj, attr, source, patched in self._iter_patch_candidates():
            if patched:
                ...
                self.assertFalse(source.startswith("freenet_passlib_170."),
    ...
    def assert_patched(self, context=None):
        ...
        for obj, attr, source, patched in self._iter_patch_candidates():
            if patched:
                self.assertTrue(source == "freenet_passlib_170.ext.django.utils",
    ...
    def load_extension(self, check=True, **kwds):
        ...
        import freenet_passlib_170.ext.django.models
        if check:
    ...
    def unload_extension(self):
        ...
        if mod:
            ...
            del sys.modules["freenet_passlib_170.ext.django.models"]
...
class DjangoBehaviorTest(_ExtensionTest):
    ...
    def test_config(self):
        ...
        if patched:
            ...
            from freenet_passlib_170.ext.django.models import password_context
...
class ExtensionBehaviorTest(DjangoBehaviorTest):
    """test model to verify freenet_passlib_170.ext.django conforms to it"""
...
class DjangoExtensionTest(_ExtensionTest):
    """test the ``freenet_passlib_170.ext.django`` plugin"""
    descriptionPrefix = "freenet_passlib_170.ext.django plugin"
    ...
    def test_01_overwrite_detection(self):
        ...
        from freenet_passlib_170.ext.django.models import adapter
        def dummy():
            pass
    ...
    def test_02_handler_wrapper(self):
        ...
        from freenet_passlib_170.hash import sha256_crypt
    ...
    def test_13_config_defaults(self):
        ...
        from freenet_passlib_170.ext.django.utils import PASSLIB_DEFAULT
    ...
    def test_14_config_invalid(self):
        ...
        self.assertRaises(TypeError, __import__, 'freenet_passlib_170.ext.django.models')

        self.unload_extension()
        update_settings(PASSLIB_CONFIG="missing-preset", PASSLIB_CONTEXT=UNSET)
        self.assertRaises(ValueError, __import__, 'freenet_passlib_170.ext.django.models')
