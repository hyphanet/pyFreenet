"""freenet_passlib_170.tests.tox_support - helper script for tox tests"""
#=============================================================================
# init script env
#=============================================================================
import os, sys
...
# site
# pkg
from freenet_passlib_170.utils.compat import print_
# local
__all__ = [
]
...
# main
#=============================================================================
TH_PATH = "freenet_passlib_170.tests.test_handlers"
...
def do_hash_tests(*args):
    ...
    while True:
        if args[0] == "--method":
            ...
            break
    from freenet_passlib_170.tests import test_handlers
