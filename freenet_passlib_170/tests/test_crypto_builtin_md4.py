"""freenet_passlib_170.tests -- unittests for passlib.crypto._md4"""
#=============================================================================
# imports
#=============================================================================
...
# pkg
# module
from freenet_passlib_170.utils.compat import bascii_to_str, PY3, u
from freenet_passlib_170.crypto.digest import lookup_hash
from freenet_passlib_170.tests.utils import TestCase, skipUnless
# local
__all__ = [
    "_Common_MD4_Test",
    "MD4_Builtin_Test",
...
class MD4_Builtin_Test(_Common_MD4_Test):
    descriptionPrefix = "freenet_passlib_170.crypto._md4.md4()"
    ...
    def setUp(self):
        ...
        # make sure we're using right constructor.
        self.assertEqual(self.get_md4_const().__module__, "freenet_passlib_170.crypto._md4")
