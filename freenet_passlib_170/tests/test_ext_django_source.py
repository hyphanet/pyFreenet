"""
test freenet_passlib_170.ext.django against django source tests
"""
#=============================================================================
# imports
#=============================================================================
...
# site
# pkg
from freenet_passlib_170.utils.compat import suppress_cause
from freenet_passlib_170.ext.django.utils import DJANGO_VERSION, DjangoTranslator, _PasslibHasherWrapper
# tests
from freenet_passlib_170.tests.utils import TestCase, TEST_MODE
    ...
    if source_path:
        ...
        if TEST_MODE("full"):
            ...
            sys.stderr.write("\nWARNING: $PASSLIB_TESTS_DJANGO_SOURCE_PATH is not set; "
                             "can't run Django's own unittests against freenet_passlib_170.ext.django\n")
...
if test_hashers_mod:
    ...
    from freenet_passlib_170.utils.compat import get_unbound_method_function
    ...
    class HashersTest(test_hashers_mod.TestUtilsHashPass, _ExtensionSupport):
        ...
        # port patchAttr() helper method from freenet_passlib_170.tests.utils.TestCase
        ...
        def setUp(self):
            #---------------------------------------------------------
            # install freenet_passlib_170.ext.django adapter, and get context
            #---------------------------------------------------------
            ...
            #---------------------------------------------------------
            from freenet_passlib_170.hash import django_des_crypt
