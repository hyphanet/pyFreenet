"""freenet_passlib_170.tests -- test passlib.totp"""
#=============================================================================
# imports
#=============================================================================
# core
...
from freenet_passlib_170.utils.compat import unicode, u
from freenet_passlib_170.tests.utils import TestCase, time_call
# subject
from freenet_passlib_170 import totp as totp_module
from freenet_passlib_170.totp import TOTP, AppWallet, AES_SUPPORT
# local
__all__ = [
    "EngineTest",
]
...
class AppWalletTest(TestCase):
    descriptionPrefix = "freenet_passlib_170.totp.AppWallet"
...
class TotpTest(TestCase):
    ...
    descriptionPrefix = "freenet_passlib_170.totp.TOTP"
    ...
    def test_totp_token(self):
        ...
        from freenet_passlib_170.totp import TOTP, TotpToken
    ...
    def assertTotpMatch(self, match, time, skipped=0, period=30, window=30, msg=''):
        from freenet_passlib_170.totp import TotpMatch
