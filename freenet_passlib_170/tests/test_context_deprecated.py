...
from freenet_passlib_170.context import CryptContext, CryptPolicy, LazyCryptContext
from freenet_passlib_170.utils import to_bytes, to_unicode
import freenet_passlib_170.utils.handlers as uh
from freenet_passlib_170.tests.utils import TestCase, set_file
...
"""
    ...
    if not os.path.exists(sample_config_1s_path) and resource_filename:
        ...
        sample_config_1s_path = resource_filename("freenet_passlib_170.tests",
