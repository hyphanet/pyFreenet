"""tests for freenet_passlib_170.utils.(des|pbkdf2|md4)"""
#=============================================================================
# imports
#=============================================================================
...
# pkg
# module
from freenet_passlib_170.utils.compat import PY3, u, JYTHON
from freenet_passlib_170.tests.utils import TestCase, TEST_MODE, skipUnless, hb
...
class HashInfoTest(TestCase):
    ...
    descriptionPrefix = "freenet_passlib_170.crypto.digest"
    ...
    def test_norm_hash_name(self):
        ...
        from freenet_passlib_170.crypto.digest import norm_hash_name, _known_hash_names
    ...
    def test_lookup_hash_ctor(self):
        ...
        from freenet_passlib_170.crypto.digest import lookup_hash
...
class Pbkdf1_Test(TestCase):
    """test kdf helpers"""
    descriptionPrefix = "freenet_passlib_170.crypto.digest.pbkdf1"
    ...
    def test_known(self):
        ...
        from freenet_passlib_170.crypto.digest import pbkdf1
...
from freenet_passlib_170.crypto.digest import pbkdf2_hmac, PBKDF2_BACKENDS

# NOTE: relying on tox to verify this works under all the various backends.
class Pbkdf2Test(TestCase):
    """test pbkdf2() support"""
    descriptionPrefix = "freenet_passlib_170.crypto.digest.pbkdf2_hmac() <backends: %s>" % ", ".join(PBKDF2_BACKENDS)
    ...
    def test_backends(self):
        ...
        from freenet_passlib_170.crypto.digest import PBKDF2_BACKENDS
