"""freenet_passlib_170.tests.test_handlers - tests for passlib hash algorithms"""
#=============================================================================
# imports
#=============================================================================
...
# site
# pkg
from freenet_passlib_170 import hash
from freenet_passlib_170.handlers.bcrypt import IDENT_2, IDENT_2X
from freenet_passlib_170.utils import repeat_string, to_bytes
from freenet_passlib_170.utils.compat import irange
from freenet_passlib_170.tests.utils import HandlerCase, TEST_MODE
from freenet_passlib_170.tests.test_handlers import UPASS_TABLE
# module
...
class _bcrypt_test(HandlerCase):
    ...
    def crypt_supports_variant(self, hash):
        ...
        from freenet_passlib_170.handlers.bcrypt import bcrypt, IDENT_2X, IDENT_2Y
        from freenet_passlib_170.utils import safe_crypt
    ...
    def fuzz_verifier_bcrypt(self):
        ...
        from freenet_passlib_170.handlers.bcrypt import IDENT_2, IDENT_2A, IDENT_2B, IDENT_2X, IDENT_2Y, _detect_pybcrypt
        from freenet_passlib_170.utils import to_native_str, to_bytes
        try:
            import bcrypt
        except ImportError:
            return
    ...
    def fuzz_verifier_pybcrypt(self):
        ...
        from freenet_passlib_170.handlers.bcrypt import (
        ...
        from freenet_passlib_170.handlers.bcrypt import _pybcrypt as bcrypt_mod
    ...
    def fuzz_verifier_bcryptor(self):
        ...
        from freenet_passlib_170.handlers.bcrypt import IDENT_2, IDENT_2A, IDENT_2Y, IDENT_2B
        from freenet_passlib_170.utils import to_native_str
        try:
