"""tests for freenet_passlib_170.utils.scrypt"""
#=============================================================================
# imports
#=============================================================================
# core
...
from freenet_passlib_170.utils.compat import PYPY, u, bascii_to_str
from freenet_passlib_170.utils.decor import classproperty
from freenet_passlib_170.tests.utils import TestCase, skipUnless, TEST_MODE, hb
# subject
from freenet_passlib_170.crypto import scrypt as scrypt_mod
# local
__all__ = [
    "ScryptEngineTest",
    "BuiltinScryptTest",
...
class ScryptEngineTest(TestCase):
    descriptionPrefix = "freenet_passlib_170.crypto.scrypt._builtin"

    def test_smix(self):
        """smix()"""
        from freenet_passlib_170.crypto.scrypt._builtin import ScryptEngine
        rng = self.getRandom()
...
#        check_bmix(1, input, output)
    ...
    def test_salsa(self):
        """salsa20()"""
        from freenet_passlib_170.crypto.scrypt._builtin import salsa20
...
class _CommonScryptTest(TestCase):
    ...
    def descriptionPrefix(cls):
        return "freenet_passlib_170.utils.scrypt.scrypt() <%s backend>" % cls.backend
    backend = None
