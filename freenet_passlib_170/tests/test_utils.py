"""tests for freenet_passlib_170.util"""
#=============================================================================
# imports
#=============================================================================
...
# pkg
# module
from freenet_passlib_170.utils import is_ascii_safe
from freenet_passlib_170.utils.compat import irange, PY2, PY3, u, unicode, join_bytes, PYPY
from freenet_passlib_170.tests.utils import TestCase, hb, run_with_fixed_seeds
...
class MiscTest(TestCase):
    ...
    def test_compat(self):
        ...
        from freenet_passlib_170.utils import compat
        # "<module 'freenet_passlib_170.utils.compat' from 'passlib/utils/compat.pyc'>"
        self.assertRegex(repr(compat),
                         r"^<module 'freenet_passlib_170.utils.compat' from '.*?'>$")
    ...
    def test_classproperty(self):
        from freenet_passlib_170.utils.decor import classproperty
    ...
    def test_deprecated_function(self):
        from freenet_passlib_170.utils.decor import deprecated_function
        ...
        with self.assertWarningList(dict(category=DeprecationWarning,
                message="the function freenet_passlib_170.tests.test_utils.test_func() "
    ...
    def test_memoized_property(self):
        from freenet_passlib_170.utils.decor import memoized_property
    ...
    def test_getrandbytes(self):
        """getrandbytes()"""
        from freenet_passlib_170.utils import getrandbytes
    ...
    def test_getrandstr(self, seed):
        """getrandstr()"""
        from freenet_passlib_170.utils import getrandstr
    ...
    def test_generate_password(self):
        """generate_password()"""
        from freenet_passlib_170.utils import generate_password
    ...
    def test_is_crypt_context(self):
        ...
        from freenet_passlib_170.utils import is_crypt_context
        from freenet_passlib_170.context import CryptContext
    ...
    def test_genseed(self):
        """test genseed()"""
        import random
        from freenet_passlib_170.utils import genseed
    ...
    def test_crypt(self):
        ...
        from freenet_passlib_170.utils import has_crypt, safe_crypt, test_crypt
        ...
        import freenet_passlib_170.utils as mod
        orig = mod._crypt
        try:
            fake = None
    ...
    def test_consteq(self):
        ...
        from freenet_passlib_170.utils import consteq, str_consteq
    ...
    def test_saslprep(self):
        ...
        from freenet_passlib_170.utils import saslprep as sp
    ...
    def test_splitcomma(self):
        from freenet_passlib_170.utils import splitcomma
...
class CodecTest(TestCase):
    """tests bytes/unicode helpers in freenet_passlib_170.utils"""
    ...
    def test_to_bytes(self):
        """test to_bytes()"""
        from freenet_passlib_170.utils import to_bytes
    ...
    def test_to_unicode(self):
        """test to_unicode()"""
        from freenet_passlib_170.utils import to_unicode
    ...
    def test_to_native_str(self):
        """test to_native_str()"""
        from freenet_passlib_170.utils import to_native_str
    ...
    def test_is_same_codec(self):
        """test is_same_codec()"""
        from freenet_passlib_170.utils import is_same_codec
...
class Base64EngineTest(TestCase):
    ...
    def test_constructor(self):
        from freenet_passlib_170.utils.binary import Base64Engine, AB64_CHARS
    ...
    def test_ab64_decode(self):
        """ab64_decode()"""
        from freenet_passlib_170.utils.binary import ab64_decode
    ...
    def test_ab64_encode(self):
        """ab64_encode()"""
        from freenet_passlib_170.utils.binary import ab64_encode
    ...
    def test_b64s_decode(self):
        """b64s_decode()"""
        from freenet_passlib_170.utils.binary import b64s_decode
    ...
    def test_b64s_encode(self):
        """b64s_encode()"""
        from freenet_passlib_170.utils.binary import b64s_encode
...
class _Base64Test(TestCase):
    ...
    def test_codec(self):
        ...
        engine = self.engine
        from freenet_passlib_170.utils import getrandbytes, getrandstr
        rng = self.getRandom()
        saw_zero = False
        for i in irange(500):
            #
...
from freenet_passlib_170.utils.binary import h64, h64big
