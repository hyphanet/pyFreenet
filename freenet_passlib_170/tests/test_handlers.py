...
from freenet_passlib_170.utils.compat import irange, PY3, u, get_method_function
from freenet_passlib_170.tests.utils import TestCase, HandlerCase, skipUnless, \
...
def get_handler_case(scheme):
    ...
    for module in ("test_handlers", "test_handlers_argon2", "test_handlers_bcrypt",
        ...
        modname = "freenet_passlib_170.tests." + module
        __import__(modname)
...
class cisco_type7_test(HandlerCase):
    ...
    def test_90_decode(self):
        ...
        from freenet_passlib_170.utils import to_unicode, to_bytes
...
class lmhash_test(EncodingHandlerMixin, HandlerCase):
    ...
    def test_90_raw(self):
        ...
        from freenet_passlib_170.utils.compat import str_to_bascii
        lmhash = self.handler
        for secret, hash in self.known_correct_hashes:
            kwds = {}
