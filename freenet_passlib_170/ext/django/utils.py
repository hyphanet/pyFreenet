"""freenet_passlib_170.ext.django.utils - helper functions used by this plugin"""
#=============================================================================
# imports
#=============================================================================
# core
...
try:
    ...
    DJANGO_VERSION = ()
# pkg
from freenet_passlib_170 import exc, registry
from freenet_passlib_170.context import CryptContext
from freenet_passlib_170.exc import PasslibRuntimeWarning
from freenet_passlib_170.utils.compat import get_method_function, iteritems, OrderedDict, unicode
...
#: minimum version supported by freenet_passlib_170.ext.django
...
# map preset names -> freenet_passlib_170.app attrs
_preset_map = {
...
def get_preset_config(name):
    ...
    * ``"passlib-default"`` - default config used by this release of freenet_passlib_170.
    ...
    * ``"django-1.6"`` - config used by stock Django 1.6 installs
    ...
    import freenet_passlib_170.apps
    return getattr(freenet_passlib_170.apps, attr).to_string()
...
class DjangoTranslator(object):
    ...
    def _create_django_hasher(self, django_name):
        ...
        module = sys.modules.get("freenet_passlib_170.ext.django.models")
...
class DjangoContextAdapter(DjangoTranslator):
    ...
    When installed in django, :mod:`!freenet_passlib_170.ext.django` will create
    ...
    def __init__(self, context=None, get_user_category=None, **kwds):
        ...
        if make_password.__module__.startswith("freenet_passlib_170."):
    ...
    def install_patch(self):
        ...
        if DJANGO_VERSION < MIN_DJANGO_VERSION:
            raise RuntimeError("freenet_passlib_170.ext.django requires django >= %s" %
                               (MIN_DJANGO_VERSION,))
    ...
    def load_model(self):
        ...
        if self.enabled:
            ...
            self.remove_patch()
        log.debug("freenet_passlib_170.ext.django loaded")
...
class _PasslibHasherWrapper(object):
    """
    adapter which which wraps a :cls:`freenet_passlib_170.ifc.PasswordHash` class,
    and provides an interface compatible with the Django hasher API.

    :param passlib_handler:
        passlib hash handler (e.g. :cls:`freenet_passlib_170.hash.sha256_crypt`.
    """
    #=====================================================================
    # instance attrs
    #=====================================================================
...
##from freenet_passlib_170.utils import classproperty, to_native_str, to_unicode
##from freenet_passlib_170.utils.compat import unicode
##
##
