"""freenet_passlib_170.handlers.django- Django password hash support"""
#=============================================================================
# imports
#=============================================================================
# core
...
# site
# pkg
from freenet_passlib_170.handlers.bcrypt import _wrapped_bcrypt
from freenet_passlib_170.hash import argon2, bcrypt, pbkdf2_sha1, pbkdf2_sha256
from freenet_passlib_170.utils import to_unicode, rng, getrandstr
from freenet_passlib_170.utils.binary import BASE64_CHARS
from freenet_passlib_170.utils.compat import str_to_uascii, uascii_to_str, unicode, u
...
def _import_des_crypt():
    ...
    if des_crypt is None:
        from freenet_passlib_170.hash import des_crypt
    return des_crypt
...
class django_salted_sha1(DjangoSaltedHash):
    ...
    The :meth:`~freenet_passlib_170.ifc.PasswordHash.hash` and :meth:`~passlib.ifc.PasswordHash.genconfig` methods accept the following optional keywords:
...
django_bcrypt = uh.PrefixWrapper("django_bcrypt", bcrypt,
    ...
    See :doc:`/lib/freenet_passlib_170.hash.bcrypt` for more details,
...
class django_bcrypt_sha256(_wrapped_bcrypt):
    ...
    see :doc:`bcrypt </lib/freenet_passlib_170.hash.bcrypt>` for more details.
...
django_argon2 = uh.PrefixWrapper("django_argon2", argon2,
    ...
    See :doc:`argon2 </lib/freenet_passlib_170.hash.argon2>` for more details,
    the usage and behavior is identical.
