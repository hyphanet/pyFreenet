"""freenet_passlib_170.handlers.sha2_crypt - SHA256-Crypt / SHA512-Crypt"""
#=============================================================================
# imports
#=============================================================================
# core
...
# site
# pkg
from freenet_passlib_170.utils import safe_crypt, test_crypt, \
                          repeat_string, to_unicode
from freenet_passlib_170.utils.binary import h64
from freenet_passlib_170.utils.compat import byte_elem_value, u, \
...
def _raw_sha2_crypt(pwd, salt, rounds, use_512=False):
    ...
    #       others from being DOSed in this way (see freenet_passlib_170.exc.PasswordSizeError
    #       for details).
