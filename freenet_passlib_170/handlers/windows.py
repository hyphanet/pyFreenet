"""freenet_passlib_170.handlers.nthash - Microsoft Windows -related hashes"""
#=============================================================================
# imports
#=============================================================================
# core
...
# site
# pkg
from freenet_passlib_170.utils import to_unicode, right_pad_string
...
class lmhash(uh.TruncateMixin, uh.HasEncodingContext, uh.StaticHandler):
    ...
    The :meth:`~freenet_passlib_170.ifc.PasswordHash.using` method accepts a single
    optional keyword:
    ...
    The :meth:`~freenet_passlib_170.ifc.PasswordHash.hash` and :meth:`~passlib.ifc.PasswordHash.verify` methods accept a single
    optional keyword:
    ...
    def raw(cls, secret, encoding=None):
        ...
        from freenet_passlib_170.crypto.des import des_encrypt_block
        MAGIC = cls._magic
...
class nthash(uh.StaticHandler):
    ...
    The :meth:`~freenet_passlib_170.ifc.PasswordHash.hash` and :meth:`~passlib.ifc.PasswordHash.genconfig` methods accept no optional keywords.
...
class msdcc2(uh.HasUserContext, uh.StaticHandler):
    ...
    def raw(cls, secret, user):
        ...
        :returns: returns string of raw bytes
        """
        from freenet_passlib_170.crypto.digest import pbkdf2_hmac
        secret = to_unicode(secret, "utf-8", param="secret").encode("utf-16-le")
        user = to_unicode(user, "utf-8", param="user").lower().encode("utf-16-le")
