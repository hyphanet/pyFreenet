"""freenet_passlib_170.bcrypt -- implementation of OpenBSD's BCrypt algorithm.
...
from freenet_passlib_170.exc import PasslibHashWarning, PasslibSecurityWarning, PasslibSecurityError
from freenet_passlib_170.utils import safe_crypt, repeat_string, to_bytes, parse_version, \
                          rng, getrandstr, test_crypt, to_unicode
from freenet_passlib_170.utils.binary import bcrypt64
from freenet_passlib_170.utils.compat import u, uascii_to_str, unicode, str_to_uascii
    ...
    def _finalize_backend_mixin(mixin_cls, backend, dryrun):
        ...
        def assert_lacks_8bit_bug(ident):
            ...
            if verify(secret, bug_hash):
                ...
                raise PasslibSecurityError(
                    "freenet_passlib_170.hash.bcrypt: Your installation of the %r backend is vulnerable to "
        ...
        if not result:
            ...
            if detect_wrap_bug(IDENT_2A):
                warn("freenet_passlib_170.hash.bcrypt: Your installation of the %r backend is vulnerable to "
...
class _BuiltinBackend(_BcryptCommon):
    ...
    @classmethod
    def _load_backend_mixin(mixin_cls, name, dryrun):
        from freenet_passlib_170.utils import as_bool
        ...
        from freenet_passlib_170.crypto._blowfish import raw_bcrypt as _builtin_bcrypt
        return mixin_cls._finalize_backend_mixin(name, dryrun)
...
class bcrypt_sha256(_wrapped_bcrypt):
    ...
    The :meth:`~freenet_passlib_170.ifc.PasswordHash.hash` and :meth:`~passlib.ifc.PasswordHash.genconfig` methods accept
