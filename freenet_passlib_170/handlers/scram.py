"""freenet_passlib_170.handlers.scram - hash for SCRAM credential storage"""
#=============================================================================
# imports
#=============================================================================
# core
...
# site
# pkg
from freenet_passlib_170.utils import consteq, saslprep, to_native_str, splitcomma
from freenet_passlib_170.utils.binary import ab64_decode, ab64_encode
from freenet_passlib_170.utils.compat import bascii_to_str, iteritems, u, native_string_types
from freenet_passlib_170.crypto.digest import pbkdf2_hmac, norm_hash_name
...
class scram(uh.HasRounds, uh.HasRawSalt, uh.HasRawChecksum, uh.GenericHandler):
    ...
    def extract_digest_info(cls, hash, alg):
        ...
        :arg alg:
            ...
            This value is run through :func:`~freenet_passlib_170.crypto.digest.norm_hash_name`,
