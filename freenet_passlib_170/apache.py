"""freenet_passlib_170.apache - apache password support"""
# XXX: relocate this to freenet_passlib_170.ext.apache?
#=============================================================================
# imports
#=============================================================================
...
from freenet_passlib_170.exc import ExpectedStringError
from freenet_passlib_170.hash import htdigest
from freenet_passlib_170.utils import render_bytes, to_bytes, is_ascii_codec
from freenet_passlib_170.utils.decor import deprecated_method
from freenet_passlib_170.utils.compat import join_bytes, unicode, BytesIO, PY3
# local
__all__ = [
    'HtpasswdFile',
    'HtdigestFile',
...
class HtpasswdFile(_CommonFile):
    ...
    :type context: :class:`~freenet_passlib_170.context.CryptContext`
    :param context:
...
class HtdigestFile(_CommonFile):
    ...
    def get_hash(self, user, realm=None):
        """Return :class:`~freenet_passlib_170.hash.htdigest` hash stored for user.
