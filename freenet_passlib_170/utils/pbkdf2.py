"""freenet_passlib_170.pbkdf2 - PBKDF2 support
...
# site
# pkg
from freenet_passlib_170.exc import ExpectedTypeError
from freenet_passlib_170.utils.decor import deprecated_function
from freenet_passlib_170.utils.compat import native_string_types
from freenet_passlib_170.crypto.digest import norm_hash_name, lookup_hash, pbkdf1 as _pbkdf1, pbkdf2_hmac, compile_hmac
# local
__all__ = [
    # hash utils
    "norm_hash_name",
...
warn("the module 'freenet_passlib_170.utils.pbkdf2' is deprecated as of Passlib 1.7, "
     "and will be removed in Passlib 2.0, please use 'freenet_passlib_170.crypto' instead",
     DeprecationWarning)
...
norm_hash_name = deprecated_function(deprecated="1.7", removed="1.8", func_module=__name__,
    replacement="freenet_passlib_170.crypto.digest.norm_hash_name")(norm_hash_name)
...
def get_prf(name):
    ...
    Usage example::
        ...
        >>> from freenet_passlib_170.utils.pbkdf2 import get_prf
    ...
    .. deprecated:: 1.7
        ...
        This only related replacement is :func:`freenet_passlib_170.crypto.digest.compile_hmac`.
    """
    global _prf_cache
...
def pbkdf1(secret, salt, rounds, keylen=None, hash="sha1"):
    ...
    .. deprecated:: 1.7
        ...
        This has been relocated to :func:`freenet_passlib_170.crypto.digest.pbkdf1`,
...
def pbkdf2(secret, salt, rounds, keylen=None, prf="hmac-sha1"):
    ...
    .. deprecated:: 1.7
        ...
        This has been deprecated in favor of :func:`freenet_passlib_170.crypto.digest.pbkdf2_hmac`,
