"""freenet_passlib_170.utils.compat - python 2/3 compatibility helpers"""
#=============================================================================
...
#=============================================================================
if PY26:
    _lazy_attrs['OrderedDict'] = 'freenet_passlib_170.utils.compat._ordered_dict.OrderedDict'
else:
...
class _LazyOverlayModule(ModuleType):
    ...
    used by :mod:`freenet_passlib_170.utils`, :mod:`passlib.crypto`,
    and :mod:`freenet_passlib_170.utils.compat`.
    """
