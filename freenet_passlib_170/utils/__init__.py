"""freenet_passlib_170.utils -- helpers for writing password hashes"""
#=============================================================================
# imports
#=============================================================================
from freenet_passlib_170.utils.compat import JYTHON
# core
...
from freenet_passlib_170.utils.decor import (
    # [remove these aliases in 2.0]
    deprecated_function,
    deprecated_method,
    memoized_property,
...
from freenet_passlib_170.utils.compat import (add_doc, join_bytes, join_byte_values,
...
# XXX: should this be moved to freenet_passlib_170.crypto, or compat backports?
...
@deprecated_function(deprecated="1.7", removed="2.0",
                     replacement="freenet_passlib_170.pwd.genword() / passlib.pwd.genphrase()")
...
def is_crypt_context(obj):
    """check if object appears to be a :class:`~freenet_passlib_170.context.CryptContext` instance"""
