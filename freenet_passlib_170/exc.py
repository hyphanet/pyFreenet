"""freenet_passlib_170.exc -- exceptions & warnings raised by passlib"""
#=============================================================================
# exceptions
#=============================================================================
...
class MissingBackendError(RuntimeError):
    ...
    :class:`~freenet_passlib_170.hash.bcrypt`).
    """
...
class PasswordTruncateError(PasswordSizeError):
    ...
    Hashers such as :class:`~freenet_passlib_170.hash.bcrypt` can be configured to raises
...
class TokenError(ValueError):
    """
    Base error raised by v:mod:`freenet_passlib_170.totp` when
...
class MalformedTokenError(TokenError):
    """
    Error raised by :mod:`freenet_passlib_170.totp` when a token isn't formatted correctly
...
class InvalidTokenError(TokenError):
    """
    Error raised by :mod:`freenet_passlib_170.totp` when a token is formatted correctly,
...
class UsedTokenError(TokenError):
    """
    Error raised by :mod:`freenet_passlib_170.totp` if a token is reused.
...
class UnknownHashError(ValueError):
    """Error raised by :class:`~freenet_passlib_170.crypto.lookup_hash` if hash name is not recognized.
...
class PasslibConfigWarning(PasslibWarning):
    ...
    of a :class:`~freenet_passlib_170.context.CryptContext` instance.
